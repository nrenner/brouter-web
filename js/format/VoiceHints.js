(function () {
    class Command {
        constructor(name, locus, locusSymbol, orux, symbol, fit, message) {
            this.name = name;
            this.locus = locus;
    ...
    class RoundaboutCommand extends Command {
        constructor(command, exitNumber) {
            super(
                ...
                command.locusSymbol + exitNumber,
    ...
    VoiceHints.commands = (function () {
        return {
            //     Command(name, locus, locusSymbol, orux, symbol, fit, message)
            1: new Command('C', 1, 'straight', 1002, 'Straight', 'straight', 'straight'),
            2: new Command('TL', 4, 'left', 1000, 'Left', 'left', 'left'),
            3: new Command('TSLL', 3, 'left_slight', 1017, 'TSLL', 'slight_left', 'slight left'),
            4: new Command('TSHL', 5, 'left_sharp', 1019, 'TSHL', 'sharp_left', 'sharp left'),
            5: new Command('TR', 7, 'right', 1001, 'Right', 'right', 'right'),
            6: new Command('TSLR', 6, 'right_slight', 1016, 'TSLR', 'slight_right', 'slight right'),
            7: new Command('TSHR', 8, 'right_sharp', 1018, 'TSHR', 'sharp_right', 'sharp right'),
            8: new Command('KL', 9, 'stay_left', 1015, 'TSLL', 'left_fork', 'keep left'),
            9: new Command('KR', 10, 'stay_right', 1014, 'TSLR', 'right_fork', 'keep right'),
            ...
            10: new Command('TU', 13, 'u-turn_left', 1003, 'TU', 'u_turn', 'u-turn'), // Left U-turn
            ...
            11: new Command('TRU', 14, 'u-turn_right', 1003, 'TU', 'u_turn', 'u-turn'), // Right U-turn
            12: new Command('OFFR', undefined, undefined, undefined, 'OFFR', 'danger', undefined), // Off route
            13: new Command('RNDB', 26, 'roundabout_e', 1008, 'RNDB', 'generic', 'Take exit '), // Roundabout
            14: new Command('RNLB', 26, 'roundabout_e', 1008, 'RNLB', 'generic', 'Take exit '), // Roundabout left
            15: new Command('TU', 12, 'u-turn', 1003, 'TU', 'u_turn', 'u-turn'), // 180 degree u-turn
            16: new Command('BL', undefined, 'beeline', undefined, 'BL', 'danger', undefined), // Beeline
        };
    })();
